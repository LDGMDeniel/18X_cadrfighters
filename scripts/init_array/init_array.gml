...
global.chars[2,4]=3; //модель - аватар для представления на поле боя, если у нас будет графон
...
global.chars[3,3]=1; //картинка, число, аватар
global.chars[3,4]=3; //модель - аватар для представления на поле боя, если у нас будет графон
