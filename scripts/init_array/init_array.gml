...
global.item[1,3]="y";   //iequip     цвет - буква(r/b/y), цветовое ограничение экипировки
...
global.item[1,6]=4;	    //ic1        ссылка - число, если не 0, то ссылка на дополнительные карты этого предмета"
...
global.item[2,10]="y";  //aresist    сопротивление - буква(r/b/y), определяет уязвимость для оружия
