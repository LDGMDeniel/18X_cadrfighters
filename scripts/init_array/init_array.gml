...
global.chars[2,1]="Рандомный бандит"; //имя, строка
global.chars[2,2]="r"; //цвет - число или буква, определяющие какое снаряжение ему можно
global.chars[2,3]=8; //картинка, число, аватар
